...
export default function GestionUsuarios() {
    ...
    return (
        <div className="space-y-8">
            {/* Encabezado */}
            <div>
                <h2 className="text-3xl font-extrabold text-slate-800 tracking-tight">Gestión del Personal 👥</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 h-fit">
                    <h3 className="text-lg font-bold text-slate-800 mb-4">💼 Registrar Personal</h3>
                    ...
                    <form onSubmit={handleCreateEmpleado} className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            {/* AGREGAR ESTE BLOQUE COMPLETITO DEL DNI */}
<div>
  ...
  />
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-4 py-2 border border-slate-300 bg-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            >
                ...
                <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                        <h3 className="font-bold text-slate-800 text-lg">Staff Registrado</h3>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                ...
                                <tbody className="divide-y divide-slate-100 text-sm text-slate-700">
                                    {usuarios.map((usr) => (
                                        <tr key={usr.id_usuario || usr.id} className="hover:bg-slate-50/70 transition-colors">
